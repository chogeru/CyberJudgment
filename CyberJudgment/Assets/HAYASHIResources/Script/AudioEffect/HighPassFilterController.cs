...
/// <summary>
/// HighPassフィルタを制御するクラス
/// </summary>
public class HighPassFilterController : IAudioFilterController
{
    private AudioHighPassFilter filter;

    public HighPassFilterController(AudioHighPassFilter filter)
    {
        this.filter = filter;
    }
