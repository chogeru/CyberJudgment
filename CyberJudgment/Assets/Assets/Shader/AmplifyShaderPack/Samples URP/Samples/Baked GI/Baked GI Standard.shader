	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * (SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MainTex, temp_output_133_0_g31 )).rgb ).x;
...
Node;AmplifyShaderEditor.FunctionNode;52;192,224;Inherit;False;Material Baked GI;35;;26;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;4;975;FLOAT3;0,0,1;False;765;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
Node;AmplifyShaderEditor.FunctionNode;33;-128,0;Inherit;False;Material Sample;1;;31;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;12;FLOAT3;1;FLOAT3;6;FLOAT3;372;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
...
ASEEND*/
//CHKSM=6BA1C52F2C9F8D3CB422879143418A39BF69BB2C