	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float3 vertexValue = ( _VertexOffset * v.ase_normal * 0.1 );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 transform111 = mul(GetObjectToWorldMatrix(),float4( IN.ase_normal , 0.0 ));
				float4 normalizeResult110 = normalize( transform111 );
				float4 normalDirection114 = normalizeResult110;
				float3 normalizeResult46 = normalize( ( _WorldSpaceCameraPos - WorldPosition ) );
				...
				float3 Color = max( float4( 0,0,0,0 ) , ( ( scatterMap137 + innerRing158 ) * saturate( pow( max( 0.0 , saturate( ( dotResult311 + ( max( dotResult364 , -0.22 ) * _LightMultiply ) ) ) ) , _LightExp ) ) * ase_lightAtten * _MainLightColor ) ).rgb;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.RangedFloatNode;125;-1158.017,-1277.134;Float;False;Property;_GlowOffset;Glow Offset;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;119;-1193.986,-1503.918;Float;False;Property;_ScatteringOffset;Scattering Offset;1;0;Create;True;0;0;0;False;0;False;0;-2.04;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;148;1711.763,-492.9884;Float;False;Property;_GlowColor;Glow Color;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.9528301,0.9267859,0.6427109,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;287;2230.955,553.2716;Float;False;Property;_LightMultiply;Light Multiply;10;0;Create;True;0;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;142;280.3493,-1004.899;Float;False;Property;_ScatteringFactor;Scattering Factor;4;0;Create;True;0;0;0;False;0;False;0;-1.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;522.897,-995.204;Float;False;Property;_ScatteringIntensity;Scattering Intensity;3;0;Create;True;0;0;0;False;0;False;0;4.73;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;394;3038.671,312.6016;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;376;2912.691,531.2031;Float;False;Property;_LightExp;Light Exp;9;0;Create;True;0;0;0;False;0;False;0;2.44;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightAttenuation;374;4133.759,139.2585;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;379;4606.409,246.2952;Float;False;Property;_VertexOffset;Vertex Offset;12;0;Create;True;0;0;0;False;0;False;0;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;381;4857.409,4.295197;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;397;4970.498,-128.8551;Inherit;False;Constant;_Float2;Float 2;14;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;351;2339.858,9.880451;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;396;4690.498,-358.8551;Inherit;False;Constant;_Float0;Float 0;14;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;394;1;377;0
WireConnection;158;0;157;0
WireConnection;137;0;147;0
WireConnection;366;0;394;0
