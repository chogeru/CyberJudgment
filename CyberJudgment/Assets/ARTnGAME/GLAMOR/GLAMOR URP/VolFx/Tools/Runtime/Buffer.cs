...
namespace Artngame.GLAMOR.VolFx.Tools
{
    public class Buffer : ScriptableObject
    {
        ...
        private void OnValidate()
        {
            ...
            var lrf =UnityEditor.AssetDatabase.LoadAllAssetsAtPath(
                UnityEditor.AssetDatabase.GetAssetPath(this)).OfType<VolFxBuffers>().FirstOrDefault(n => n._list.Contains(this)
                );
            if (lrf != null)
                lrf.Create();
#endif
